...
@section('title')
{{ $citoyen->prenom . " " . $citoyen->nom }} edition
@endsection
...
<div class="m5">
    ...
    <form method="post" action="{{ route('inscription.editMembres',['inscription'=>$inscription->numero]) }}"
        ...
        <table class="table table-striped table-bordered m-auto h5 text-center">
            ...
            <tbody id="lignes">
                ...
                <tr>
                    ...
                    <td>
                        @if($key !=0)
                        <a href="{{ route('inscription.removeMembre', ['inscription'=>$inscription->numero,'membre'=>$key]) }}"
