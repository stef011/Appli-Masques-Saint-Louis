...
<div class="m5">
    ...
    <form method="post" action="{{ route('inscription.add') }}" class="m-auto table-responsive"
        ...
        <table class="table table-striped table-bordered m-auto h5 text-center">
            ...
            <tbody id="lignes">
                ...
                <tr>
                    ...
                    <td>
                        @if($key !=0)
                        <a href="{{ route('inscription.remove', ['membre'=>$key]) }}" type='button'
        ...
        <div class="d-flex justify-content-between mt-5">
            ...
            <a href="{{ route('inscription.confirm') }}" type="button" class="btn btn-success btn-shadow">Valider
                et
                terminer</a>
        </div>
